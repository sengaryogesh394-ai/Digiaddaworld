  ...
  useEffect(() => {
    const loadProduct = async () => {
      try {
        ...
        // Fetch product data from API instead of direct database access
        ...
        {pricing.hasPromotion && (
          <section className="w-screen relative overflow-hidden">
            ...
            <div className="relative py-16 px-4">
              <div className="container mx-auto max-w-6xl text-center">
                <div className="mb-8">
                  <h2 className="text-3xl md:text-4xl font-black text-red-600 mb-4 animate-pulse" style={{ fontFamily: 'Oswald, sans-serif' }}>
                    ⏰ LIMITED TIME OFFER!
                  </h2>
                  <p className="text-xl md:text-2xl text-gray-800 dark:text-gray-200 font-bold">
                    Get {pricing.discountPercentage}% OFF - Price Increases Soon!
                  </p>
                </div>
                
                <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border-4 border-red-200 mb-8">
                  <CountdownTimer 
                ...
                <button className="bg-gradient-to-r from-red-600 via-orange-600 to-yellow-600 hover:from-red-700 hover:via-orange-700 hover:to-yellow-700 text-white px-12 py-5 rounded-full text-xl md:text-2xl font-black shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:scale-105 animate-pulse" style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 900 }}>
                  <span className="flex items-center justify-center gap-3">
                    <span className="animate-bounce">⚡</span>
